  ...
  <div style="margin: 10px;">
    <el-card class="box-card" shadow="never">
      ...
      <div style="margin-top: 5px">
        ...
        <el-button type="success" size="mini" icon="el-icon-s-grid" @click="handleAction">权 限</el-button>
...
import JyPermissionMenuAction from '@/views/jy-system/permission-menu/permission-menu-action'
export default {
  name: 'JyPermissionMenu',
  components: { JyPermissionMenuAction, JyPermissionMenuDetail, JyPermissionMenuForm },
  data() {
    return {
      queryForm: {
        name: '',
  ...
  methods: {
    ...
    handleAction() {
      ...
      this.actionEditData.title = '接口权限配置'
      this.actionEditData.id = this.selectData.current.id
      this.actionEditData.name = this.selectData.current.name
